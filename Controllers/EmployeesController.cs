...
namespace LUUDUCDAT_MaNguonMo.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly MvcLUUDUCDAT_MaNguonMoContext _context;

        public EmployeesController(MvcLUUDUCDAT_MaNguonMoContext context)
        {
            _context = context;
        }
